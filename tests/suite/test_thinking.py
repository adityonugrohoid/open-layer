...
from tests.conftest import ProviderConfig, require_thinking, require_budget
...
async def test_thinking_disabled_no_thinking_field(
    ...
    # When disabled, thinking should be absent or have empty/null content
...
async def test_budget_tokens_accepted(
    ...
    require_thinking(provider_config)
    require_budget(provider_config)
    payload = {
        "model": provider_config.thinking_model,
